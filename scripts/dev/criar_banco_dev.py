...
try:
    ...
    cursor.execute("""
        ...
        VALUES
            (1, 1, 'Conta Nubank', 'corrente', 1000, 1),
            (2, 2, 'Conta Bradesco', 'corrente', 2500, 1),
            (3, 3, 'Conta Inter', 'corrente', 800, 1);
    """)
    ...
    cursor.execute("""
        ...
        VALUES
            (1, 1, 'Nubank', 3000, 5, 10, 1, 1),
            (2, 2, 'Bradesco', 2500, 8, 15, 1, 1),
            (3, 3, 'Inter', 2000, 10, 17, 1, 1);
    """)
    ...
    # Orçamento de teste do mês atual.
    cursor.execute("""
    ...
    print()
    print("=" * 55)
    print("BANCO DEV CRIADO COM SUCESSO")
    print("=" * 55)
